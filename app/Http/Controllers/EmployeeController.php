...
class EmployeeController extends Controller
{
    ...
    public function store()
    {
        ...
        //redirect
        return redirect(route('employees.index'))->with('added', 'Employee '.ucwords($employee->name).' has been created');
    }
    ...
    public function destroy(Employee $employee)
    {
        ...
        return redirect('/employees')->with('deleted', 'Employee '.ucwords($employee->name).' has been deleted');;
    }
